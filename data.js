...
window.ROADMAP = {
  ...
  phases: [
      ...
      skills: [
        ...
        },
        {
          ...
          items: [
            ...
            "Step through Brendan Bycroft's 3D LLM Visualization — watch inference happen",
            "Read The Illustrated Transformer (Jay Alammar) for the attention picture",
            "Write KV-cache bytes & per-token FLOPs as functions of (B, S, L, H, d)",
            "Compute MFU for a given config",
            "Use kipply's Inference Arithmetic only as a number-dense cross-check",
          ],
          links: [
            ["LLM Visualization — Brendan Bycroft (interactive 3D)", "https://bbycroft.net/llm"],
            ["The Illustrated Transformer — Jay Alammar", "https://jalammar.github.io/illustrated-transformer/"],
            ["Transformer Explainer (interactive)", "https://poloclub.github.io/transformer-explainer/"],
            ["How to Scale Your Model (JAX/TPU, diagram-rich)", "https://jax-ml.github.io/scaling-book/"],
            ["Transformer Inference Arithmetic — kipply (number-dense reference)", "https://kipp.ly/transformer-inference-arithmetic/"],
          ],
        },
        {
          id: "m1-exec",
          title: "Execution Model & MAIA",
          items: [
            "Internalize the MAIA spec sheet (Maia 100 → 200: HBM, bandwidth, tensor + vector units, tile/cluster layout)",
            "Understand the MX (microscaling) data formats MAIA uses and how they change the arithmetic",
            "Read the Maia 200 architecture deep-dive end to end — your target hardware",
          ...
          links: [
            ["Maia 200 architecture deep-dive (Microsoft)", "https://techcommunity.microsoft.com/blog/azureinfrastructureblog/deep-dive-into-the-maia-200-architecture/4489312"],
            ["Inside Maia 100 (Microsoft)", "https://techcommunity.microsoft.com/blog/azureinfrastructureblog/inside-maia-100-revolutionizing-ai-workloads-with-microsofts-custom-ai-accelerat/4229118"],
            ["Azure Maia: from silicon to software to systems", "https://azure.microsoft.com/en-us/blog/azure-maia-for-the-era-of-ai-from-silicon-to-software-to-systems/"],
          ],
        },
      ],
    },
...

    {
      ...
      skills: [
        ...
        },
        {
          ...
          title: "Triton (User)",
          items: [
            "GPU MODE Lecture 14: A Practitioner's Guide to Triton (work the notebook)",
            "Official tutorials 01–06: vec add → softmax → matmul → fused attention",
            "Triton-Puzzles (Sasha Rush) for retrieval practice",
            "Work through Triton Academy + the curated triton-resources path",
            "Read Liger-Kernel as clean production Triton",
            "Skim Helion for how it layers above Triton",
          ],
          links: [
            ["GPU MODE: A Practitioner's Guide to Triton (notebook)", "https://github.com/gpu-mode/lectures/blob/main/lecture_014/A_Practitioners_Guide_to_Triton.ipynb"],
            ["Triton tutorials", "https://triton-lang.org/main/getting-started/tutorials/index.html"],
            ["Triton-Puzzles", "https://github.com/srush/Triton-Puzzles"],
            ["Triton Academy", "https://github.com/MekkCyber/TritonAcademy"],
            ["Curated Triton resources (rkinas)", "https://github.com/rkinas/triton-resources"],
        ...
        },
        {
          ...
          items: [
            ...
            "Narrate ttir → ttgir → llir → target (PTX, or a non-NVIDIA backend)",
            "Study layouts / encodings, the pipelining pass, coalescing",
            "Trace how Triton lowers to a non-NVIDIA backend — directly relevant to the Maia Triton compiler you work on",
            "GPU MODE Lecture 29: Triton Internals",
          ],
          links: [
            ["Triton repo", "https://github.com/triton-lang/triton"],
            ["GPU MODE lectures (Triton Internals, low-bit kernels)", "https://github.com/gpu-mode/lectures"],
            ["gpu-mode/triton-index (kernel catalog)", "https://github.com/gpu-mode/triton-index"],
            ["Maia SDK: Triton as a programming model", "https://blogs.microsoft.com/blog/2026/01/26/maia-200-the-ai-accelerator-built-for-inference/"],
          ],
        },
      ],
    },
...

    {
      ...
      skills: [
        ...
        {
          id: "m912-models",
          title: "Frontier OSS Models",
          items: [
            "GLM-5 / 5.2 (Zhipu): 744B MoE, 40B active, 1M context, DeepSeek Sparse Attention — read the technical report",
            "DeepSeek-V3: Multi-head Latent Attention (MLA), fine-grained MoE, multi-token prediction",
            "Trace one model's architecture diagram end to end; mark what differs from a vanilla transformer",
            "Map each innovation to its inference cost: KV-cache, attention, MoE routing",
          ],
          links: [
            ["GLM-5 technical report (arXiv)", "https://arxiv.org/abs/2602.15763"],
            ["GLM-5 — zai-org (GitHub)", "https://github.com/zai-org/GLM-5"],
            ["DeepSeek-V3 technical report (arXiv)", "https://arxiv.org/abs/2412.19437"],
            ["DeepSeek-V3 Explained: Multi-head Latent Attention (visual)", "https://towardsdatascience.com/deepseek-v3-explained-1-multi-head-latent-attention-ed6bee2a67c4/"],
            ["A Visual Guide to Mixture of Experts — Grootendorst", "https://newsletter.maartengrootendorst.com/p/a-visual-guide-to-mixture-of-experts"],
          ],
        },
        {
          id: "m912-opt",
          ...
          items: [
            ...
            "Low-precision formats: FP8 and MX (MAIA's native microscaling)",
            "FlexAttention — custom attention without CUDA",
          ],
          links: [
            ["A Visual Guide to Quantization — Grootendorst (50+ visuals)", "https://newsletter.maartengrootendorst.com/p/a-visual-guide-to-quantization"],
  ...
  maintenance: {
    ...
    items: [
      ...
      "The MAIA spec sheet; ridge points (and one other accelerator for contrast)",
      ...
      "Concept deck: FlashAttention 1–3, PagedAttention, MLA, MoE routing, DeepSeek Sparse Attention, GSPMD, ZeRO, speculative decoding, PTQ vs QAT, FP8/MX",
    ],
  },
};
